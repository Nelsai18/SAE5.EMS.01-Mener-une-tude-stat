...
```
La courbe monte tout le temps, sans jamais redescendre: ça veut dire qu’on ajoute des points de charge chaque mois et que le parc grossit en continu sur toute la période.La pente devient de plus en plus forte à partir de 2017–2018 puis surtout 2019–2020: le rythme d’installation s’accélère, on n’est plus dans une phase de test mais dans un vrai déploiement massif.
