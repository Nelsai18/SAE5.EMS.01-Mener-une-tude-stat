# Mission 3 : Appel de charge au réseau électrique

## Analyse de la consommation d'électricité en France et des filières de production.
...
Choix de l'année à représenter
```{r}
library(dplyr)
